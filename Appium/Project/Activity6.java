...
//        System.out.println(driver.getWindowHandles().size());
    ...
    public void popUpTest2() {
        ...
        driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text='admin']")).sendKeys("admin");
        driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text='password']")).clear();
        driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text='password']")).sendKeys("sdf");
